...
namespace UnityServicesLocator
{
    public class ServiceLocator : MonoBehaviour
    {
        ...
        public static ServiceLocator ForSceneOf(MonoBehaviour mb)
        {
            ...
            // If the scene container is not found, search for a ServiceLocatorScene in the scene.
        ...
        // Called when the runtime is initialized. This method for cleaning up static variables.
